...
class SomonaukCountryKitchen extends Component {
    render() {
        return (
            <div>
                    ...
                    <div className="col infoArea">
                        ...
                        <div className="row descriptionArea">
                            <div id="descriptionArea">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi commodi delectus
                                    dolor
                                    dolorem dolores facere itaque obcaecati praesentium ullam? Aperiam beatae
                                    consequuntur
                                    cum cupiditate delectus deleniti dolor dolore, dolorum error facere impedit ipsum
                                    laudantium maiores molestias necessitatibus nesciunt officia omnis optio
                                    perspiciatis
                                    quaerat quis reiciendis repellendus sit ut voluptate! Earum expedita fuga impedit
                                    nemo
                                    nihil. Delectus eaque fuga id rerum veritatis voluptates! Ab, animi architecto
                                    aspernatur assumenda distinctio, eligendi fugiat in iure minus modi molestiae
                                    quaerat,
                                    quos recusandae reiciendis sequi soluta unde! Distinctio laudantium pariatur
                                    voluptate.
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus ducimus fugit
                                    ...
                                    cupiditate expedita facere fugit itaque, laudantium numquam porro quaerat, quia
                                    ullam
                                    vero.</p>
                            </div>
                        </div>
                        ...
                        <form>
                            ...
                            <div className="row">
                                <div className="col text-center">
                                    ...
                                    <input className="form-control" id="resDay" type="date"
                                           placeholder="11/11/2022"></input>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col text-center">
